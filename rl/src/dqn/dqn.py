...
class DQN(SingleAgentBase):
    ...
    def __init__(
        ...
        epsilon_decay: float = 0.000003,
        slow_decay_point: float = 1.0,
        slow_decay_factor: float = 1.0,
        batch_size: int = 32,
        tau: float = 0.005,
    ...
    def reset(self) -> None:
        ...
        self.policy_net = self.policy.policy_net
        self.target_net = self.policy.target_net
        self.optimizer = OptimizerManager(self.policy_net, self.hp.lr).initialize()
